...
local hash = loadstring(downloadFile('halovape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('halovape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('halovape/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('halovape/profiles/whitelist.json') and readfile('halovape/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('halovape/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('halovape/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('halovape/assets/new/radaricon.png'),
